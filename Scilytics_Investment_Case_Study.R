...
# Alternate way of cleaning
mapping_long$category_list <- gsub("0","na",mapping_long$category_list)
mapping_long$category_list <- gsub("2.na","2.0", mapping_long$category_list)
